...
import { createChecktout } from "@/actions/checkout";
...
const Cart = () => {
    ...
    const handleFinishPurchaseClick = async () => {
        const checkout = await createChecktout(products);
    ...
    return ( 
        <div className="h-full flex flex-col gap-8">
            ...
            <div className="h-full max-h-full flex flex-col gap-5 overflow-hidden">
